    ...
    bool target_vulkan_1_3)
{
    ...
    m_spirv = CompileGLSLToSPIRV(glsl_code, entry_point, stage, target_vulkan_1_3, m_defines);
    if (m_spirv.empty())
    {
    ...
    std::span<const std::pair<std::string, std::string>> defines)
{
    ...
    glslang_input_t input = {
        ...
        .client_version = target_vulkan_1_3 ? GLSLANG_TARGET_VULKAN_1_3 : GLSLANG_TARGET_VULKAN_1_2,
        .target_language = GLSLANG_TARGET_SPV,
        .target_language_version = target_vulkan_1_3 ? GLSLANG_TARGET_SPV_1_6 : GLSLANG_TARGET_SPV_1_5,
