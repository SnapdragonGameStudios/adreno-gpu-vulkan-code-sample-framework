...
public:
    ...
    * @param target_vulkan_1_3 : when true, target Vulkan 1.3 / SPIR-V 1.6 (needed
    *        for coopmat + memory-scope shaders). When false, target Vulkan 1.2 /
    *        SPIR-V 1.5 so the module passes spirv-val on a 1.2 device. The caller
    *        should match this to the device's apiVersion.
